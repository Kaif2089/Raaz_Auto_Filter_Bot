...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002689409318'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002689409318'))  # Bin channel id (make sure bot is admin)
